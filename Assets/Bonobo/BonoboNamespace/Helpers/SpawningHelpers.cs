...
namespace Bonobo
{
    ...
    {
        public static GameObject SpawnPrefabTransforms(GameObject prefab, Transform transform)
        {
        ...
        public static GameObject SpawnIdentityTransforms(GameObject prefab, Transform transform, bool scaleZero = false)
        {
